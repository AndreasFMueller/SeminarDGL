...
Ausserdem brauchen wir Rechenregeln, wie man mit Wiener-Prozessen Funktionen
rechnen kann.
...
\end{align*}
Im letzten Schritt haben wir einen Faktor $\Delta_k$ aus der Summer
...
\subsection{Lineare stochastische Differentialgleichungen}
