...
Doch die Differentialgleichung \eqref{skript:exp-dgl} hat die L"osungen
\[
f(t)=a\cos t+b\sin t.
\]
...
wir k"onnen sie auch mit den Formeln \eqref{skript:realteil-formel} und
\eqref{skript:imaginaerteil-formel} ausdr"ucken:
\begin{align*}
\cos t
&=
...
\end{align}
Die Eulerformel \eqref{skript:euler-formula} l"asst sich also auch in der
...
dass es sich in der Form \eqref{skript:su2form} schreiben l"asst.
...
$[\,\cdot\,,\,\cdot\,]$,
welche die Jacobi-Identit"at \eqref{skript:jacobi} erf"ullt, heisst eine
{\em Lie-Algebra}.
\index{Lie-Algebra}%
