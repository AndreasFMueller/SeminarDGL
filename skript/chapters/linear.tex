...
\begin{satz}
\label{linear:apq}
Die Matrix $A(p,q)^k$ hat die Matrixeelemente
\begin{equation}
(A(p,q)^k)_{ij}
=\begin{cases}
...
$A(p,q)^k$ obere Dreicksmatrizen sein, was die Formel~\ref{linear:apqk}
auch ausdr"uckt.
...
In der Basis $B'=\{v, w\}$ hat die Matrix des Differntialgleichungssystems
die Form
\[
A'
=
...
Matrixsituation "ubertragbar, abe wir k"onnen vesuchen, das Resultat
...
(\ref{linear:nichtkommutativ-diffquot}) weitef"uhren, wir
erhalten
\begin{align*}
\frac{d}{dt}X(t)
&=
