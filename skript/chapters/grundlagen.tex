...
y_0+
\begin{pmatrix}
{{\cos x\,\left(\left(\omega-1\right)\,\sin \left(\left(
 \omega+1\right)\,x\right)+\left(\omega+1\right)\,\sin \left(\left(1-
 \omega\right)\,x\right)\right)}\over{2\,\omega^2-2}}+\sin x\,\left(
 {{\omega}\over{\omega^2-1}}-{{\left(\omega-1\right)\,\cos \left(
 \left(\omega+1\right)\,x\right)+\left(\omega+1\right)\,\cos \left(
 \left(\omega-1\right)\,x\right)}\over{2\,\omega^2-2}}\right)\cr 
 \cos x\,\left({{\omega}\over{\omega^2-1}}-{{\left(\omega-1\right)\,
 \cos \left(\left(\omega+1\right)\,x\right)+\left(\omega+1\right)\,
 \cos \left(\left(\omega-1\right)\,x\right)}\over{2\,\omega^2-2}}
 \right)-{{\sin x\,\left(\left(\omega-1\right)\,\sin \left(\left(
 \omega+1\right)\,x\right)+\left(\omega+1\right)\,\sin \left(\left(1-
 \omega\right)\,x\right)\right)}\over{2\,\omega^2-2}}
\end{pmatrix}
\end{align*}
Davon interessiert uns nur die erste Komponente, sie ist
\[
\frac1{2(\omega^2-1)}\biggl(
 (\omega-1)(\cos x\,\sin \left(\omega\,x+x\right)
-\,\sin x\,\cos \left(\omega\,x+x\right))
-(\omega+1)(\,\cos x\,\sin \left(\omega\,x-x\right)
              \sin x\,\cos \left(\omega\,x-x\right))
+{\omega\,\sin x}
\biggr)
