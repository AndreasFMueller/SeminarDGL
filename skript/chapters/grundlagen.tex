...
%noch mit der Differentialgleichung \eqref{grundlagen:shiftdgl} berechnen.
%Durch einsetzen finden wir die Differentialgleichung
%\[
%v'=-2xy v
%\]
%F"ur $y$ m"ussen wir die L"osung \eqref{grundlagen:startloesung}
...
die Rechnung:
\lstinputlisting[style=Maxima]{chapters/examples/dgl2.maxima}
