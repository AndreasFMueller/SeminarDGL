...
\section[Potenzreihenentwicklung der Besselfunktion]{Potenzreihenentwicklung der Besselfunktion 1. Art
\label{kreis:teil2}}
...
\begin{compactenum}
	...
	\item \dots die \emph{Bessel-Funktionen} erster Art \refeq{eq:bessel:summenformel}.
...
\subsubsection{\arabic{stepCounter}. Schritt: Indexgleichung zur Bestimmung von $\varrho$}
...
\stepcounter{stepCounter}
Mit der Indexgleichung \refeq{eq:bessel:indexgleichung:ausgangslage:vereinfacht} kann $n$ f\"ur $\varrho$ in die Gleichung \refeq{eq:bessel:potenzreihe:dgl:vereinfacht} eingesetzt werden:
\begin{align}
	\big(
	n \, \left( n - 1 \right)
	+
...
\begin{align}
	...
	\text{.}
\end{align}
In der Gleichung \refeq{eq:bessel:potenzreihe:dgl:index:eingesetzt:gleichesummen} k\"onnen die einzelnen Summen zu einer einzigen Summe zusammengefasst werden.
...
Durch die Indexgleichung \refeq{eq:bessel:indexgleichung:ausgangslage:vereinfacht} kann sichergestellt werden,
...
Da mit der Rekursionsformel \refeq{eq:bessel:koeffizienten:rekursion} $a_1$ aus $a_{-1}$ berechnet werden kann und $a_{-1} = 0$ ist,
...
\begin{align}
	...
	\text{.}
\end{align}
\subsubsection{\arabic{stepCounter}. Schritt: \emph{Bessel-Funktionen} erster Art}
\stepcounter{stepCounter}
\index{Besselfunktionen erster Art}
...
\begin{align}
	...
	\text{.}
\end{align}
In der Potenzreihe \refeq{eq:bessel:potenzreihe:koeffizienten:eingesetzt} gibt es den unbekannten Koeffizienten $a_0$,
...
die Gleichung \refeq{eq:bessel:potenzreihe:koeffizienten:eingesetzt} weiter zu vereinfachen.
