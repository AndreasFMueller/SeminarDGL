...
\begin{compactenum}
	...
	\item Die Potenzreihen in die Differentialgleichung \refeq{eq:bessel:dgl} eingesetzen, um \dots
...
\end{align}
\begin{normalsize}%
was wiederum eine Potenzreihe \refeq{eq:bessel:potenzreihe:ersteableitung} und \refeq{eq:bessel:potenzreihe:zweiteableitung} ergibt.
\end{normalsize}
