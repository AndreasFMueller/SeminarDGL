...
Die ersten drei Summen haben als Start-Index $k = 0$,
...
\end{align}
\begin{normalsize}%
In der Potenzreihe \refeq{eq:bessel:potenzreihe:koeffizienten:eingesetzt} gibt es den unbekannten Koeffizient $a_0$,
welcher f\"ur die weiteren Koeffizienten ben\"otigt wird.
Da keine Bedinungen f\"ur den Koeffizent $a_0$ vorliegen,
kann dieser frei bestimmt werden,
