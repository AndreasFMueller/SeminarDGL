...
\begin{equation*}
	S_\text{tol} = \left( 
			...
			\right) 
			\qquad\text{mit}\qquad
			\lambda_1 \geq \lambda_2 \geq \dots \lambda_{\text{tol}} > 0. 
\end{equation*}
...
\begin{equation*}
	...
	\label{trafo:1D_DGL}
\end{equation*}
Diese Differentialgleichung l"asst sich mit
\begin{equation*}
	x_h(t) = x_0 e^{\lambda t}
	\label{trafo:homogene_Loesung}
\end{equation*}
l"osen, wobei $x_h$ die homogene L"osung ist. Den Fehlerterm $b(t)$ wird im n"achsten Abschnitt etwas genauer betrachtet. 
...
\rhead{Anwendung der gefundenen L"osungen}
