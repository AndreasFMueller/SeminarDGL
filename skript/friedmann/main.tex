...
\begin{enumerate}
	...
	\item $\Lambda = 0$ 
		...
		\end{align*}
		%Wenn linke Seite positiv sein muss, kann Kappa nur negativ oder null sein. Einstein wollte jedoch statisch, geschlossenes Universum, darum der \Lambda-Term
\end{enumerate}
