...
Auch hier gibt es zwei mögliche Ausprägungen. Das Universum ist statisch und für alle Zeit $a_0$, wenn $\kappa = 0$ ist, für $\kappa > 0$ wächst das Universum linear mit der Zeit an.
...
F_G = -\frac{m M G}{D^2}
\end{equation}
Da die Gravitationskraft zwecks Vereinfachung des Modells als einzige Kraft wirkt, gilt für die Beschleunigung $A$ (Hier $A$, da der Kleinbuchstabe $a$ für den Skalenfaktor reserviert ist.) von $m$ mit $F = m A$ :
