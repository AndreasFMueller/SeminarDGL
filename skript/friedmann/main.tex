...
Die sogenannte Friedmann-Lema\^{i}tre-Gleichung beschreibt das Verhalten des Universums nach der Inflation des Kosmos im Rahmen des Standard-Urknall-Modells. Die \textbf{Energiedichte} $\rho$, die \textbf{Krümmung} $\kappa$ und die \textbf{Dunkle Energie} $\Lambda$ sind die Parameter der Gleichung.
\begin{equation}
