...
\begin{document}
  ...
  \begin{frame}
    ...
    $$n(y) = 1, \qquad n'_y(y) = \frac{\partial n}{\partial y} = 0$$
  ...
  \begin{frame}
    ...
    \begin{center}
      \begin{tikzpicture}
       ...
       (10.00000,6.67204) };
        \addlegendentry{$f'(0) = 1.4, \: \Delta \alpha \approx 30.0^\circ$}
       ...
       (10.00000,9.80340) };
       \addlegendentry{$f'(0) = 1.8, \: \Delta \alpha \approx 21.6^\circ$}
  ...
  \begin{frame}
    ...
    $$\text{Bei dieser Simulation:} \quad \mu = 1, \quad \sigma = 1, \quad r_0 = r(0) = 1$$
  ...
  \begin{frame}
    ...
    \begin{center}
      \includegraphics[scale=0.22]{../images/athmosphereProfileCut.png}
    \end{center}    
