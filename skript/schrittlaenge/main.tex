...
\begin{equation}
a=\frac{G \cdot m}{r^2} \label{eq:beschleunigungSkalar}
\end{equation}
...
\begin{equation}
\frac{d^2 \vec{s_1}}{dt^2} =\frac{G \cdot m}{\mid -2\vec{s_{1}}\mid ^2}\cdot \frac{-2\vec{s_{1}}}{\mid -2\vec{s_{1}}\mid}
\end{equation}
...
\begin{equation}
\frac{d^2\vec{s}}{dt^2}=\frac{G\cdot m}{4\mid\vec{s}\mid ^2}\cdot\frac{-\vec{s}}{\mid\vec{s}\mid}=-\frac{G\cdot m}{4\mid\vec{s}\mid ^3}{\vec{s}}
\end{equation}
...
\end{pmatrix}
=
-\frac{G \cdot m}{4\sqrt{s_x^2 + s_y^2}^3}
\begin{pmatrix}
s_x \\ s_y
\end{pmatrix}
\end{equation}
...
\frac{d^2s_x}{dt^2}=-\frac{G \cdot m \cdot s_x}{4\sqrt{s_x^2 + s_y^2}^3}
\end{equation}
\begin{equation} \label{eq:kompSchreibwZwei}
\frac{d^2s_y}{dt^2}=-\frac{G \cdot m \cdot s_y}{4\sqrt{s_x^2 + s_y^2}^3}
\end{equation}
...
s_{x1} \\ 
-\frac{G \cdot m \cdot s_x}{4\sqrt{s_x^2 + s_y^2}^3} \\
\end{pmatrix}
\end{equation}
\begin{equation}
\frac{d}{dt} \begin{pmatrix}
...
\end{pmatrix} = \begin{pmatrix}
s_{y1} \\ 
-\frac{G \cdot m \cdot s_y}{4\sqrt{s_x^2 + s_y^2}^3} \\
\end{pmatrix}
\end{equation}
...
z_3 \\ 
z_4 \\
-\frac{G \cdot m \cdot z_1}{4\sqrt{z_1^2 + z_2^2}^3} \\
-\frac{G \cdot m \cdot z_2}{4\sqrt{z_1^2 + z_2^2}^3}
\end{pmatrix}
\end{equation}
